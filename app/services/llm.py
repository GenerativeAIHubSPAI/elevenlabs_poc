...
class LLMClient:
    ...
    async def answer(
        ...
        input_text = (
            ...
            "- If the context contains product catalogue information, extract the product names, references, descriptions, and prices.\n"
            "- If the answer is not present in the context, say exactly what information is missing.\n"
